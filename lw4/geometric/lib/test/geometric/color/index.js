...
var colorError_1 = require("../../../geometric/error/colorError");
var assert = require('assert');
function testGetColorNumberFromString() {
    describe('Get color number from string', function () {
        ...
        it('Should check incorrect colors and throw exception if necessary', function () {
            ...
            incorrectColors.forEach(function (color) {
                try {
                    ...
                    if (!(e instanceof colorError_1.ColorError))
                        throw e;
                }
            });
        });
...
exports.testGetColorNumberFromString = testGetColorNumberFromString;
function testGetColorHexStringFromNumber() {
    describe('Get color hex string from string', function () {
...
exports.testGetColorHexStringFromNumber = testGetColorHexStringFromNumber;
