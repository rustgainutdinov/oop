...
function getColorHexStringFromNumber(colorNum) {
    if (colorNum < 0 || colorNum > 0xFFFFFF) {
        throw new colorError_1.ColorError('Incorrect num to translate to hex');
    }
